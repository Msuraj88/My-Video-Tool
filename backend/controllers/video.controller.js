...
const { generateSceneDirection, extractHighlightPhrases } = require('../services/sceneDirector');
const { buildScenePrompt } = require('../services/promptBuilder');
const { generateAudio } = require('../services/aiRouter');
    ...
    try {
        ...
        for (let i = 0; i < scenes.length; i++) {
            ...
            const sceneData = {
                ...
                highlights: extractHighlightPhrases(scene.text)
            };
